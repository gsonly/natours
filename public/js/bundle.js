      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 200) {
              (0, _alert.default)('success', 'successfully logged in');
              setTimeout(function () {
...
var _default = function _default(locations) {
  var token = 'pk.eyJ1IjoidHIxbSIsImEiOiJja2ttcGZjaHUyaHU2MnZuN212Z2U5cHdzIn0.1zv94vl_Z0WdEe7MSmu8Vw';
  ...
  locations.forEach(function (l) {
    ...
    var popup = new mapboxgl.Popup({
      ...
      closeOnClick: false,
      closeOnMove: false
    }).setLngLat(l.coordinates).setHTML("Day: ".concat(l.day, " - ").concat(l.description)).setMaxWidth('300px').addTo(map);
...
if (form) {
  form.addEventListener('submit', function (e) {
    ...
    if (email === '' || password === '') return (0, _alert.default)('error', 'please provide your email and password');
    (0, _auth.login)({
      email: email,
      password: password
    });
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./auth":"auth.js","./map":"map.js","./alert":"alert.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
